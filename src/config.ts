...
export function resolveWithDefault(
  userConfig: PredeployUserConfig | undefined,
): PredeployConfig {
  return Object.fromEntries(
    Object.entries(merge(defaultConfig, userConfig)).map(
      ([address, details]) => [
...
export const defaultConfig: PredeployUserConfig = {
  "0x0000000071727De22E5E9d8BAf0edAc6f37da032": {
    ...
    abi: path.resolve(
      ...
      "../bin/0x0000000071727De22E5E9d8BAf0edAc6f37da032.abi",
    ),
    bytecode: path.resolve(
      path.dirname(__filename),
      "../bin/0x0000000071727De22E5E9d8BAf0edAc6f37da032.bytecode",
    ),
  },
  ...
  "0x4337084D9E255Ff0702461CF8895CE9E3b5Ff108": {
    ...
    abi: path.resolve(
      path.dirname(__filename),
      "../bin/0x4337084D9E255Ff0702461CF8895CE9E3b5Ff108.abi",
    ),
    bytecode: path.resolve(
      path.dirname(__filename),
      "../bin/0x4337084D9E255Ff0702461CF8895CE9E3b5Ff108.bytecode",
    ),
  },
  "0x449ED7C3e6Fee6a97311d4b55475DF59C44AdD33": {
    ...
    abi: path.resolve(
      path.dirname(__filename),
      "../bin/0x449ED7C3e6Fee6a97311d4b55475DF59C44AdD33.abi",
    ),
    bytecode: path.resolve(
      path.dirname(__filename),
      "../bin/0x449ED7C3e6Fee6a97311d4b55475DF59C44AdD33.bytecode",
    ),
  },
